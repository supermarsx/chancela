...
<p align="center">
  ...
  <a href="license.md"><img alt="License: Chancela Source License (non-commercial)" src="https://img.shields.io/badge/license-non--commercial-blue?style=flat-square"></a>
...
| License | [Chancela Source License](license.md) — MIT-derived, non-commercial use only |
...
Chancela is released under the [Chancela Source License](license.md): the MIT
License plus a commercial-use restriction. Non-commercial use, modification and
redistribution are free; any commercial use requires a separate commercial
licence from the copyright holder before that use begins.
