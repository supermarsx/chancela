  ...
  return (
    <div className="stack">
      ...
      {/* One section at a time; the panel replays the route-enter fade on each switch, as
          ...
          measure: its complete Termo editor is an aligned label/control table with nested
          clause and signatory rows. The prose and smaller table sections remain narrow. */}
      <div
        className={
          section === 'opening' ? 'route-transition stack wide-page' : 'route-transition stack'
        }
        key={section}
      >
        {section === 'opening' ? (
          <>
            <Card title={t('books.termoAbertura')}>
              <dl className="deflist book-opening-summary">
                <div>
