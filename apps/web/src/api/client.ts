...
export const api = {
  ...
  getSearchSettings: () => get<SearchSettings>('/v1/search/settings'),
  putSearchSettings: (body: SearchSettings) => put<SearchSettings>('/v1/search/settings', body),
  ...
  updateBook: (id: string, body: UpdateBookBody) => patch<BookView>(`/v1/books/${id}`, body),
