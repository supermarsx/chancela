...
export const templatesCatalogEnglish = {
  ...
  'templates.catalog.preview.hint':
    'Choose one view at a time: PDF and Markdown are complete structural proofs generated by the server from the same model. Replaceable fields remain unresolved.',
  'templates.catalog.preview.narrative':
