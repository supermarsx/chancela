...
export const opsConfigPtPT = {
  ...
  // — Formato documental herdável ———————————————————————————————————————
  'documentLayout.title': 'Formato e tipografia dos documentos',
  'documentLayout.section.page.title': 'Página',
  'documentLayout.section.page.description': 'Formato, orientação e margens físicas do PDF/A.',
  'documentLayout.section.typography.title': 'Tipografia',
  'documentLayout.section.typography.description':
    'Tipos de letra incorporados, tamanhos e ritmo do texto.',
  'documentLayout.section.regions.title': 'Cabeçalho e rodapé',
  'documentLayout.section.regions.description':
    'Separação segura entre o conteúdo e as regiões fixas.',
  'documentLayout.field.pageSize': 'Formato da página',
  'documentLayout.field.orientation': 'Orientação',
  'documentLayout.field.marginTop': 'Margem superior',
  'documentLayout.field.marginRight': 'Margem direita',
  'documentLayout.field.marginBottom': 'Margem inferior',
  'documentLayout.field.marginLeft': 'Margem esquerda',
  'documentLayout.field.bodyFont': 'Tipo de letra do corpo',
  'documentLayout.field.bodySize': 'Tamanho do corpo',
  'documentLayout.field.headerFont': 'Tipo de letra do cabeçalho',
  'documentLayout.field.headerSize': 'Tamanho do cabeçalho',
  'documentLayout.field.footerFont': 'Tipo de letra do rodapé',
  'documentLayout.field.footerSize': 'Tamanho do rodapé',
  'documentLayout.field.lineSpacing': 'Entrelinha',
  'documentLayout.field.paragraphSpacing': 'Espaço entre parágrafos',
  'documentLayout.field.headingScale': 'Escala dos títulos',
  'documentLayout.field.headerGap': 'Espaço após o cabeçalho',
  'documentLayout.field.footerGap': 'Espaço antes do rodapé',
  'documentLayout.option.pageSize.A4': 'A4 · 210 × 297 mm',
  'documentLayout.option.pageSize.A5': 'A5 · 148 × 210 mm',
  'documentLayout.option.pageSize.Letter': 'Letter · 216 × 279 mm',
  'documentLayout.option.pageSize.Legal': 'Legal · 216 × 356 mm',
  'documentLayout.option.orientation.Portrait': 'Vertical',
  'documentLayout.option.orientation.Landscape': 'Horizontal',
  'documentLayout.option.font.NotoSerif': 'Noto Serif',
  'documentLayout.option.font.NotoSans': 'Noto Sans',
  'documentLayout.mode.default': 'Modo predefinido',
  'documentLayout.mode.inherit': 'Herdar',
  'documentLayout.mode.override': 'Substituir',
  'documentLayout.mode.aria': 'Modo de {label}',
  'documentLayout.hint.override': 'Substitui o valor {source}.',
  'documentLayout.value.inherited': 'Valor {source}',
  'documentLayout.hint.inherited': '{label}: {value}.',
  'documentLayout.action.resetProduct': 'Repor predefinições do produto',
  'documentLayout.action.resetInherited': 'Repor tudo para herdado',
  'documentLayout.action.saving': 'A guardar…',
  'documentLayout.action.saveEntity': 'Guardar formato da entidade',
  'documentLayout.action.saveBook': 'Guardar formato do livro',
  'documentLayout.source.instance': 'da instância',
  'documentLayout.source.previousLevels': 'dos níveis anteriores',
  'documentLayout.baseline.instance': 'Valor-base da instância',
  'documentLayout.baseline.instanceEntity': 'Valor-base da instância e da entidade',
  'documentLayout.inheritance.title': 'Herança previsível',
  'documentLayout.entity.inheritance.body':
    'A entidade herda por predefinição. O modelo escolhido pode substituir a instância antes deste nível; apenas as propriedades marcadas como «Substituir» ficam guardadas na entidade e prevalecem sobre o modelo.',
  'documentLayout.book.inheritance.body':
    'O livro herda por predefinição. A resolução final segue instância → modelo → entidade → livro; apenas as propriedades marcadas como «Substituir» ficam guardadas neste livro.',
  'documentLayout.entity.hidden.title': 'Entidade não visível',
  'documentLayout.entity.hidden.body':
    'A base abaixo mostra a instância. As substituições da entidade continuam a ser aplicadas pelo servidor, mesmo sem permissão para as consultar aqui.',
  'documentLayout.entity.saved': 'Formato documental da entidade atualizado.',
  'documentLayout.book.saved': 'Formato documental do livro atualizado.',
  'documentLayout.settings.base':
    'Base concreta da instância. Os modelos, entidades e livros herdam estes valores e guardam apenas as propriedades que substituem explicitamente.',
  'documentLayout.template.title': 'Formato e tipografia',
  'documentLayout.template.inheritance.body':
...
export const opsConfigEnglish = {
  ...
  'documentLayout.title': 'Document layout and typography',
  'documentLayout.section.page.title': 'Page',
  'documentLayout.section.page.description': 'PDF/A size, orientation, and physical margins.',
  'documentLayout.section.typography.title': 'Typography',
  'documentLayout.section.typography.description': 'Embedded typefaces, sizes, and text rhythm.',
  'documentLayout.section.regions.title': 'Header and footer',
  'documentLayout.section.regions.description':
    'Safe separation between content and fixed regions.',
  'documentLayout.field.pageSize': 'Page size',
  'documentLayout.field.orientation': 'Orientation',
  'documentLayout.field.marginTop': 'Top margin',
  'documentLayout.field.marginRight': 'Right margin',
  'documentLayout.field.marginBottom': 'Bottom margin',
  'documentLayout.field.marginLeft': 'Left margin',
  'documentLayout.field.bodyFont': 'Body typeface',
  'documentLayout.field.bodySize': 'Body size',
  'documentLayout.field.headerFont': 'Header typeface',
  'documentLayout.field.headerSize': 'Header size',
  'documentLayout.field.footerFont': 'Footer typeface',
  'documentLayout.field.footerSize': 'Footer size',
  'documentLayout.field.lineSpacing': 'Line spacing',
  'documentLayout.field.paragraphSpacing': 'Paragraph spacing',
  'documentLayout.field.headingScale': 'Heading scale',
  'documentLayout.field.headerGap': 'Space after header',
  'documentLayout.field.footerGap': 'Space before footer',
  'documentLayout.option.pageSize.A4': 'A4 · 210 × 297 mm',
  'documentLayout.option.pageSize.A5': 'A5 · 148 × 210 mm',
  'documentLayout.option.pageSize.Letter': 'Letter · 216 × 279 mm',
  'documentLayout.option.pageSize.Legal': 'Legal · 216 × 356 mm',
  'documentLayout.option.orientation.Portrait': 'Portrait',
  'documentLayout.option.orientation.Landscape': 'Landscape',
  'documentLayout.option.font.NotoSerif': 'Noto Serif',
  'documentLayout.option.font.NotoSans': 'Noto Sans',
  'documentLayout.mode.default': 'Default mode',
  'documentLayout.mode.inherit': 'Inherit',
  'documentLayout.mode.override': 'Override',
  'documentLayout.mode.aria': '{label} mode',
  'documentLayout.hint.override': 'Overrides the value {source}.',
  'documentLayout.value.inherited': 'Value {source}',
  'documentLayout.hint.inherited': '{label}: {value}.',
  'documentLayout.action.resetProduct': 'Restore product defaults',
  'documentLayout.action.resetInherited': 'Reset all to inherited',
  'documentLayout.action.saving': 'Saving…',
  'documentLayout.action.saveEntity': 'Save entity layout',
  'documentLayout.action.saveBook': 'Save book layout',
  'documentLayout.source.instance': 'from the instance',
  'documentLayout.source.previousLevels': 'from earlier levels',
  'documentLayout.baseline.instance': 'Instance baseline',
  'documentLayout.baseline.instanceEntity': 'Instance and entity baseline',
  'documentLayout.inheritance.title': 'Predictable inheritance',
  'documentLayout.entity.inheritance.body':
    'The entity inherits by default. The selected template may override the instance before this level; only properties marked “Override” are stored on the entity and take precedence over the template.',
  'documentLayout.book.inheritance.body':
    'The book inherits by default. Final resolution follows instance → template → entity → book; only properties marked “Override” are stored on this book.',
  'documentLayout.entity.hidden.title': 'Entity not visible',
  'documentLayout.entity.hidden.body':
    'The baseline below shows the instance. Entity overrides are still applied by the server even when you do not have permission to view them here.',
  'documentLayout.entity.saved': 'Entity document layout updated.',
  'documentLayout.book.saved': 'Book document layout updated.',
  'documentLayout.settings.base':
    'Concrete instance baseline. Templates, entities, and books inherit these values and store only properties they explicitly override.',
  'documentLayout.template.title': 'Layout and typography',
  'documentLayout.template.inheritance.body':
    'Inherit is the default mode. The template stores only the properties it overrides.',
