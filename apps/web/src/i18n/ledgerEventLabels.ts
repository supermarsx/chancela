...
export const ledgerEventLabelsPtPT = {
  ...
  'enum.ledgerEventKind.entity.archived': 'Entidade arquivada',
  ...
  'enum.ledgerEventKind.entity.unarchived': 'Entidade desarquivada',
  ...
  'enum.ledgerEventKind.tenant.renamed': 'Organização renomeada',
  ...
  'enum.ledgerEventKind.user.passkey.enrolled': 'Chave de acesso adicionada',
  'enum.ledgerEventKind.user.passkey.revoked': 'Chave de acesso removida',
  'enum.ledgerEventKind.user.passkey.renamed': 'Chave de acesso renomeada',
  'enum.ledgerEventKind.user.passkey.used': 'Chave de acesso utilizada',
  'enum.ledgerEventKind.user.passkey.counter_regression': 'Contador da chave de acesso não avançou',
  'enum.ledgerEventKind.user.recovery.issued': 'Recuperação de conta emitida',
  'enum.ledgerEventKind.user.self_suspended': 'Conta suspensa pelo titular',
...
export const ledgerEventLabelsEnglish: LedgerEventLabels = {
  ...
  'enum.ledgerEventKind.entity.archived': 'Entity archived',
  ...
  'enum.ledgerEventKind.entity.unarchived': 'Entity unarchived',
  ...
  'enum.ledgerEventKind.tenant.renamed': 'Organization renamed',
  ...
  'enum.ledgerEventKind.user.passkey.enrolled': 'Passkey added',
  'enum.ledgerEventKind.user.passkey.revoked': 'Passkey removed',
  'enum.ledgerEventKind.user.passkey.renamed': 'Passkey renamed',
  'enum.ledgerEventKind.user.passkey.used': 'Passkey used',
  'enum.ledgerEventKind.user.passkey.counter_regression': 'Passkey counter did not advance',
  'enum.ledgerEventKind.user.recovery.issued': 'Account recovery issued',
  'enum.ledgerEventKind.user.self_suspended': 'Account suspended by its holder',
...
export const ledgerEventLabelsPtBR: LedgerEventLabels = {
  ...
  'enum.ledgerEventKind.tenant.created': 'Organização criada',
  'enum.ledgerEventKind.tenant.renamed': 'Organização com nome alterado',
  'enum.ledgerEventKind.trust.tsl.imported': 'Importação da lista de confiança TSL tentada',
...
export const ledgerEventLabelsDaDK: LedgerEventLabels = {
  ...
  'enum.ledgerEventKind.tenant.renamed': 'Organisation omdøbt',
  ...
  'enum.ledgerEventKind.user.passkey.enrolled': 'Adgangsnøgle tilføjet',
  'enum.ledgerEventKind.user.passkey.revoked': 'Adgangsnøgle fjernet',
  'enum.ledgerEventKind.user.passkey.renamed': 'Adgangsnøgle omdøbt',
  'enum.ledgerEventKind.user.passkey.used': 'Adgangsnøgle brugt',
  'enum.ledgerEventKind.user.passkey.counter_regression': 'Adgangsnøglens tæller gik ikke frem',
  'enum.ledgerEventKind.user.recovery.issued': 'Kontogendannelse udstedt',
  'enum.ledgerEventKind.user.self_suspended': 'Konto suspenderet af indehaveren',
...
export const ledgerEventLabelsDeDE: LedgerEventLabels = {
  ...
  'enum.ledgerEventKind.tenant.renamed': 'Organisation umbenannt',
  ...
  'enum.ledgerEventKind.user.passkey.enrolled': 'Passkey hinzugefügt',
  'enum.ledgerEventKind.user.passkey.revoked': 'Passkey entfernt',
  'enum.ledgerEventKind.user.passkey.renamed': 'Passkey umbenannt',
  'enum.ledgerEventKind.user.passkey.used': 'Passkey verwendet',
  'enum.ledgerEventKind.user.passkey.counter_regression': 'Passkey-Zähler nicht weitergezählt',
  'enum.ledgerEventKind.user.recovery.issued': 'Kontowiederherstellung ausgestellt',
  'enum.ledgerEventKind.user.self_suspended': 'Konto vom Inhaber gesperrt',
...
export const ledgerEventLabelsEsES: LedgerEventLabels = {
  ...
  'enum.ledgerEventKind.tenant.renamed': 'Organización renombrada',
  ...
  'enum.ledgerEventKind.user.passkey.enrolled': 'Clave de acceso añadida',
  'enum.ledgerEventKind.user.passkey.revoked': 'Clave de acceso eliminada',
  'enum.ledgerEventKind.user.passkey.renamed': 'Clave de acceso renombrada',
  'enum.ledgerEventKind.user.passkey.used': 'Clave de acceso utilizada',
  'enum.ledgerEventKind.user.passkey.counter_regression':
    'El contador de la clave de acceso no avanzó',
  'enum.ledgerEventKind.user.recovery.issued': 'Recuperación de cuenta emitida',
  'enum.ledgerEventKind.user.self_suspended': 'Cuenta suspendida por su titular',
...
export const ledgerEventLabelsFiFI: LedgerEventLabels = {
  ...
  'enum.ledgerEventKind.tenant.renamed': 'Organisaatio nimetty uudelleen',
  ...
  'enum.ledgerEventKind.user.passkey.enrolled': 'Pääsyavain lisätty',
  'enum.ledgerEventKind.user.passkey.revoked': 'Pääsyavain poistettu',
  'enum.ledgerEventKind.user.passkey.renamed': 'Pääsyavain nimetty uudelleen',
  'enum.ledgerEventKind.user.passkey.used': 'Pääsyavainta käytetty',
  'enum.ledgerEventKind.user.passkey.counter_regression': 'Pääsyavaimen laskuri ei edennyt',
  'enum.ledgerEventKind.user.recovery.issued': 'Tilin palautus myönnetty',
  'enum.ledgerEventKind.user.self_suspended': 'Tilin haltija jäädytti tilin',
...
export const ledgerEventLabelsFrFR: LedgerEventLabels = {
  ...
  'enum.ledgerEventKind.tenant.renamed': 'Organisation renommée',
  ...
  'enum.ledgerEventKind.user.passkey.enrolled': 'Clé d’accès ajoutée',
  'enum.ledgerEventKind.user.passkey.revoked': 'Clé d’accès supprimée',
  'enum.ledgerEventKind.user.passkey.renamed': 'Clé d’accès renommée',
  'enum.ledgerEventKind.user.passkey.used': 'Clé d’accès utilisée',
  'enum.ledgerEventKind.user.passkey.counter_regression':
    'Le compteur de la clé d’accès n’a pas avancé',
  'enum.ledgerEventKind.user.recovery.issued': 'Récupération de compte émise',
  'enum.ledgerEventKind.user.self_suspended': 'Compte suspendu par son titulaire',
...
export const ledgerEventLabelsItIT: LedgerEventLabels = {
  ...
  'enum.ledgerEventKind.tenant.renamed': 'Organizzazione rinominata',
  ...
  'enum.ledgerEventKind.user.passkey.enrolled': 'Passkey aggiunta',
  'enum.ledgerEventKind.user.passkey.revoked': 'Passkey rimossa',
  'enum.ledgerEventKind.user.passkey.renamed': 'Passkey rinominata',
  'enum.ledgerEventKind.user.passkey.used': 'Passkey utilizzata',
  'enum.ledgerEventKind.user.passkey.counter_regression':
    'Il contatore della passkey non è avanzato',
  ...
  'enum.ledgerEventKind.user.self_suspended': 'Account sospeso dal titolare',
...
export const ledgerEventLabelsNlNL: LedgerEventLabels = {
  ...
  'enum.ledgerEventKind.tenant.renamed': 'Organisatie hernoemd',
  ...
  'enum.ledgerEventKind.user.passkey.enrolled': 'Toegangssleutel toegevoegd',
  'enum.ledgerEventKind.user.passkey.revoked': 'Toegangssleutel verwijderd',
  'enum.ledgerEventKind.user.passkey.renamed': 'Toegangssleutel hernoemd',
  'enum.ledgerEventKind.user.passkey.used': 'Toegangssleutel gebruikt',
  'enum.ledgerEventKind.user.passkey.counter_regression': 'Teller van toegangssleutel liep niet op',
  'enum.ledgerEventKind.user.recovery.issued': 'Accountherstel uitgegeven',
  'enum.ledgerEventKind.user.self_suspended': 'Account opgeschort door de houder',
...
export const ledgerEventLabelsPlPL: LedgerEventLabels = {
  ...
  'enum.ledgerEventKind.tenant.renamed': 'Nazwa organizacji zmieniona',
  ...
  'enum.ledgerEventKind.user.passkey.enrolled': 'Dodano klucz dostępu',
  'enum.ledgerEventKind.user.passkey.revoked': 'Usunięto klucz dostępu',
  'enum.ledgerEventKind.user.passkey.renamed': 'Zmieniono nazwę klucza dostępu',
  'enum.ledgerEventKind.user.passkey.used': 'Użyto klucza dostępu',
  'enum.ledgerEventKind.user.passkey.counter_regression': 'Licznik klucza dostępu nie wzrósł',
  'enum.ledgerEventKind.user.recovery.issued': 'Odzyskiwanie konta wydane',
  'enum.ledgerEventKind.user.self_suspended': 'Konto zawieszone przez właściciela',
...
export const ledgerEventLabelsSvFI: LedgerEventLabels = {
  ...
  'enum.ledgerEventKind.tenant.renamed': 'Organisation omdöpt',
  ...
  'enum.ledgerEventKind.user.passkey.enrolled': 'Nyckel tillagd',
  'enum.ledgerEventKind.user.passkey.revoked': 'Nyckel borttagen',
  'enum.ledgerEventKind.user.passkey.renamed': 'Nyckel omdöpt',
  'enum.ledgerEventKind.user.passkey.used': 'Nyckel använd',
  'enum.ledgerEventKind.user.passkey.counter_regression': 'Nyckelns räknare ökade inte',
  'enum.ledgerEventKind.user.recovery.issued': 'Kontoåterställning utfärdad',
  'enum.ledgerEventKind.user.self_suspended': 'Kontot avstängt av innehavaren',
