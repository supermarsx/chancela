/**
 * Focused copy for the stateless template PDF/A preview.
 *
...
export const templatesPdfPreviewPtPT = {
  'templates.pdfPreview.title': 'Pré-visualização PDF/A',
  ...
  'templates.pdfPreview.canvas':
    'Página {current} de {total} da pré-visualização PDF/A. Use Abrir PDF para uma leitura acessível no visualizador instalado.',
} as const;

export type TemplatesPdfPreviewCopyKey = keyof typeof templatesPdfPreviewPtPT;

export const templatesPdfPreviewEnglish = {
  'templates.pdfPreview.title': 'PDF/A preview',
  ...
  'templates.pdfPreview.canvas':
    'Page {current} of {total} of the PDF/A preview. Use Open PDF for accessible reading in your installed viewer.',
