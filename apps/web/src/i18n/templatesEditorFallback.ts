...
export const templatesEditorPtPT = {
  ...
  'templates.editor.blocks.addMenu': 'Escolher tipo de bloco',
  'templates.editor.blocks.configure': 'Configurar bloco',
  ...
  'templates.editor.blocks.inspector.close': 'Fechar definições',
  ...
  'templates.editor.preview.notice.markdown': 'Pré-visualização Markdown',
  ...
  'templates.editor.preview.markdown.sourceLabel': 'Conteúdo da pré-visualização Markdown',
...
export const templatesEditorEnglish = {
  ...
  'templates.editor.blocks.addMenu': 'Choose block type',
  'templates.editor.blocks.configure': 'Configure block',
  ...
  'templates.editor.blocks.inspector.close': 'Close settings',
  ...
  'templates.editor.preview.notice.markdown': 'Markdown preview',
  ...
  'templates.editor.preview.markdown.sourceLabel': 'Markdown preview content',
