...
export const templatesEditorPtPT = {
  ...
  'templates.editor.document.controls': 'Controlos dos blocos do documento',
  'templates.editor.document.narrativeMirror':
    'Corpo narrativo repetido, apenas de leitura, ocorrência {occurrence}, bloco {number}',
  ...
  'templates.editor.blocks.insertAfter': 'Inserir parágrafo depois do bloco',
  'templates.editor.blocks.duplicate': 'Duplicar bloco',
  'templates.editor.blocks.remove': 'Remover bloco',
  'templates.editor.blocks.inspector': 'Definições do bloco',
  ...
  'templates.editor.preview.notice.details': 'Detalhes',
  'templates.editor.preview.notice.structural':
    'Pré-visualização estrutural, com campos por resolver',
  'templates.editor.preview.notice.markdown': 'Documento Markdown estrutural',
  'templates.editor.preview.hint':
    'Escolha um formato de cada vez. PDF e Markdown são gerados pelo servidor a partir do mesmo documento estrutural completo, com os campos por resolver.',
  'templates.editor.preview.empty': 'Ainda não há corpo para pré-visualizar.',
  'templates.editor.preview.pausedInvalidBlocks':
  ...
  'templates.editor.preview.markdown.note':
    'Esta vista contém o documento estrutural completo do modelo, incluindo os blocos da ata e o corpo narrativo, gerado pelo mesmo modelo usado no PDF.',
  'templates.editor.preview.markdown.sourceLabel': 'Pré-visualização Markdown estrutural completa',
  'templates.editor.preview.markdown.loading': 'A gerar a pré-visualização Markdown…',
  'templates.editor.preview.markdown.updating': 'A atualizar a pré-visualização Markdown…',
  'templates.editor.preview.markdown.lastGood':
    'A última pré-visualização válida continua visível.',
  'templates.editor.preview.markdown.error.title': 'Pré-visualização Markdown indisponível',
  'templates.editor.preview.markdown.retry': 'Tentar novamente',
...
export const templatesEditorEnglish = {
  ...
  'templates.editor.document.controls': 'Document block controls',
  'templates.editor.document.narrativeMirror':
    'Repeated read-only narrative body placement, occurrence {occurrence}, block {number}',
  ...
  'templates.editor.blocks.insertAfter': 'Insert paragraph after block',
  'templates.editor.blocks.duplicate': 'Duplicate block',
  'templates.editor.blocks.remove': 'Remove block',
  'templates.editor.blocks.inspector': 'Block settings',
  ...
  'templates.editor.preview.notice.details': 'Details',
  'templates.editor.preview.notice.structural': 'Structural preview with unresolved fields',
  'templates.editor.preview.notice.markdown': 'Structural Markdown document',
  'templates.editor.preview.hint':
    'Choose one format at a time. PDF and Markdown are generated by the server from the same complete structural document, with fields unresolved.',
  'templates.editor.preview.empty': 'There is no body to preview yet.',
  'templates.editor.preview.pausedInvalidBlocks':
    'The PDF and Markdown preview is paused until the Advanced block JSON is valid.',
  ...
  'templates.editor.preview.markdown.note':
    'This view contains the complete structural template document, including ATA blocks and its narrative body, generated from the same model as the PDF.',
  'templates.editor.preview.markdown.sourceLabel': 'Complete structural Markdown preview',
  'templates.editor.preview.markdown.loading': 'Generating the Markdown preview…',
  'templates.editor.preview.markdown.updating': 'Updating the Markdown preview…',
  'templates.editor.preview.markdown.lastGood': 'The last valid preview remains visible.',
  'templates.editor.preview.markdown.error.title': 'Markdown preview unavailable',
  'templates.editor.preview.markdown.retry': 'Try again',
