...
export const enGB: Catalog = {
  ...
  'settings.serverEnv.group.notifications': 'Action Centre',
  ...
  'settings.diagnostics.intro':
    'Everything this instance already reports about itself, gathered on one screen so it can be copied, printed or saved for a support request. Nothing here is a new probe: every field comes from a panel you can open on its own.',
  'settings.diagnostics.privacyNote':
    'The export never carries a secret value, an e-mail address, an account name or a document title. Variables that hold a credential appear only as configured or not configured.',
  'settings.diagnostics.unknownNote':
    'A field that was not read says so. No status here is assumed: if a source did not answer, or your role may not read it, the row and the export both say that instead of showing a result.',
  'settings.diagnostics.tableCaption': 'Diagnostics: {section}',
  'settings.diagnostics.column.field': 'Field',
  'settings.diagnostics.column.value': 'Value',
  'settings.diagnostics.copy': 'Copy',
  'settings.diagnostics.copied': 'Report copied to the clipboard.',
  'settings.diagnostics.copyFailed':
    'The clipboard is unavailable in this window, so nothing was copied. Select the tables and copy them, or download the file instead.',
  'settings.diagnostics.download': 'Download .txt',
  'settings.diagnostics.downloaded': 'Report saved: {filename}',
  'settings.diagnostics.downloadFailed':
    'The file could not be written. Try copying the report instead.',
  'settings.diagnostics.printFailed': 'This window cannot open a print dialogue.',
  'settings.diagnostics.actionFailed': 'The report was not exported',
  'settings.diagnostics.source.ok': 'Read',
  'settings.diagnostics.source.loading': 'Reading…',
  'settings.diagnostics.source.notChecked': 'Not checked ({reason})',
  'settings.diagnostics.source.forbidden': 'Not permitted for your role',
  'settings.diagnostics.value.unknown': 'Not checked',
  'settings.diagnostics.value.error': 'Error ({code})',
  'settings.diagnostics.section.report': 'This report',
  'settings.diagnostics.section.health': 'Server and version',
  'settings.diagnostics.section.services': 'Platform services',
  'settings.diagnostics.section.env': 'Server environment',
  'settings.diagnostics.section.storage': 'Storage and database',
  'settings.diagnostics.section.ledger': 'Chain integrity',
  'settings.diagnostics.section.search': 'Search index',
  'settings.diagnostics.section.trust': 'Trust list',
  'settings.diagnostics.section.email': 'Outbound e-mail',
  'settings.diagnostics.section.credentials': 'Signature credentials',
  'settings.diagnostics.section.notCovered': 'Deliberately not included',
  ...
  'users.security.intro.self':
    'Manage your own account security here. The same credentials appear under Access and audit, where an administrator inspects and resets them — here you see them as the account holder.',
  'users.security.intro.other':
    'This account’s security state. Only the holder can manage their credentials; to reset them as an administrator, use Access and audit.',
  'users.security.password.hint': 'Sign-in password.',
  'users.security.recovery.hint':
    'Recovery phrase, an alternative to the password if it is forgotten.',
  'users.security.key.hint':
    'Audit attestation key. Rotating it makes a new key for future attestations; past ones stay verifiable.',
  'users.security.manage': 'Manage in Access and audit',
  'users.totp.title': 'Two-factor authentication',
  'users.totp.intro':
    'A second factor confirms sign-in with a code from your authenticator app, in addition to the password.',
  'users.totp.on': 'On',
  'users.totp.off': 'Off',
  ...
  'users.totp.qr.hint':
    'Scan this code with your authenticator app (Google Authenticator, Aegis, 1Password…).',
  ...
  'users.totp.backup.body':
    'Save them now, somewhere safe. Each code signs you in once without the second factor and they are not shown again.',
  ...
  'users.totp.required.hint':
    'Requires this account to hold a second factor, applied at next sign-in. It never locks access out immediately.',
  ...
  'users.totp.required.locked':
    'This account is required to keep two-factor, so it cannot be turned off.',
  'users.sessions.title': 'Active sessions',
  'users.sessions.intro':
    'The active sign-ins on this account. End a session you no longer recognise; it is rejected on its next request.',
  ...
  'documentLayout.option.alignment.Center': 'Centred',
  ...
  'settings.finder.match.keywords': 'Keyword',
  'settings.finder.match.label': 'Field',
  'settings.finder.match.value': 'Value',
  ...
  'settings.adminGroup.aria': 'Administration sections',
  'settings.adminGroup.platform': 'Platform',
  'settings.adminGroup.data': 'Data',
  'settings.adminGroup.integrations': 'Integrations',
  'settings.adminGroup.content': 'Content',
  'settings.adminGroup.signing': 'Signing',
  ...
  'signing.envelopes.completed': 'Collection completed',
  'signing.envelopes.open': 'Open',
  'signing.envelopes.notice.title': 'Backend notice',
  'signing.envelopes.completion': 'Required slots',
  'signing.envelopes.completion.summary': '{signed} of {required} with a recorded signature',
  ...
  'signing.envelopes.evidence.formNotice':
    'Records operator-supplied technical evidence for this slot and marks the slot as having a recorded signature. It does not contact providers or complete the envelope or minutes.',
  ...
  'signing.envelopes.evidence.identityMissingBody':
    'Add one tagged evidence reference for each configured identity requirement before marking the slot as having a recorded signature.',
  'signing.envelopes.evidence.submit': 'Record evidence and mark the slot signature as recorded',
  ...
  'signing.envelopes.slot.status.signed': 'Signature recorded',
  ...
  'settings.signing.anchorSuggest.code.source_is_lotl':
    'This source is the List of Trusted Lists itself. Its own anchor is published in the Official Journal of the European Union and is never taken from the document itself.',
  ...
  'settings.providerCredentials.field.amaCertPem': 'AMA certificate or public key (PEM)',
  ...
  'settings.providerCredentials.help.amaCertPem':
    'AMA’s public certificate, or the public key on its own, in PEM format. Either is accepted, because only the RSA key is used: it encrypts the mobile number, PIN and OTP before they travel in the SCMD request. Production requires it, and without it pre-production sends those fields in the clear. E.g. a “-----BEGIN CERTIFICATE-----…” or a “-----BEGIN PUBLIC KEY-----…” block.',
  ...
  'companionPair.hint.emailed_code':
    'The code you received by email. You may type it with or without the hyphens.',
  'companionPair.submit': 'Confirm and pair',
  'companionPair.pending': 'Pairing…',
  'companionPair.done.title': 'Device paired',
  'companionPair.done.body': 'This device now has access to your account. You may close this page.',
  ...
  'settings.providerCredentials.modes.purpose.cmd':
    'Remote signature through the AMA Chave Móvel Digital service. The citizen authorises each signature with the CMD PIN and a one-time code sent to their device; the signing key stays with the service.',
  ...
  'settings.providerCredentials.modes.setup.csc':
    'One entry per provider, each with its own identifier and its own HTTPS base address. Service authorisation needs the OAuth client id and client secret; user authorisation needs a previously obtained access token instead. Credential id, scope and the sandbox flag are optional, as are HTTP Basic credentials for a gateway in front of the API.',
  ...
  'settings.providerCredentials.probe.detail.cmd_ama_certificate_required_prod':
    'Production requires the AMA field-encryption key. Fill {field} on this credential entry.',
  ...
  'settings.providerCredentials.field.amaCertPem.hint':
    'The certificate or public key itself, not a path to it — PEM text beginning with BEGIN CERTIFICATE or BEGIN PUBLIC KEY.',
  ...
  'settings.providerCredentials.field.amaCertPem.inspect': 'Inspect',
  'settings.providerCredentials.field.amaCertPem.inspecting': 'Inspecting…',
  'settings.providerCredentials.field.amaCertPem.fileFilter': 'Certificate or public key (PEM)',
  ...
  'settings.providerCredentials.field.amaCertPem.empty':
    'Paste or load a certificate or a public key before inspecting it.',
  'settings.providerCredentials.field.amaCertPem.inspect.resultTitle':
    'What was established about what you supplied',
  ...
  'settings.providerCredentials.probe.detail.ama_cert_rsa_key_present':
    'What you supplied carries an RSA public key of {bits} bits, and a field encryptor was built from it. That is what a production signature needs.',
  'settings.providerCredentials.probe.detail.ama_cert_rsa_key_absent':
    'No RSA public key could be taken from what you supplied, so no field encryptor can be built from it and a production CMD signature will refuse. The parser reports: {detail}',
  ...
  'settings.providerCredentials.probe.detail.ama_cert_trust_not_established':
    'Whether this key is genuinely AMA’s was not determined: no certification path was built, no trust anchor was consulted and no Trusted List was fetched.',
  ...
  'settings.providerCredentials.field.amaCertPem.inspect.fingerprintHint':
    'Compare these against what AMA published. The public-key fingerprint covers the key itself, so it reads the same whether you were sent the certificate or the key on its own; the certificate fingerprint covers the whole certificate and is a different value for the same key. They are the only things on this panel that can tell you whether this is the right key, and the application does not compare them for you.',
  'settings.providerCredentials.field.amaCertPem.inspect.inputKind': 'What you supplied',
  ...
  'settings.providerCredentials.field.amaCertPem.inspect.inputKind.publicKey':
    'Public key on its own (no certificate)',
  ...
  'settings.providerCredentials.probe.detail.ama_cert_empty':
    'No certificate or public key was supplied.',
  'settings.providerCredentials.probe.detail.ama_cert_armour_missing':
    'No PEM armour was found: the text must contain a line reading exactly -----BEGIN CERTIFICATE----- or -----BEGIN PUBLIC KEY-----. None was added around what you pasted.',
  'settings.providerCredentials.probe.detail.ama_cert_end_armour_missing':
    'The -----BEGIN {label}----- line has no matching -----END {label}----- line, so the block looks truncated. Nothing was closed off for you.',
  'settings.providerCredentials.probe.detail.ama_cert_wrong_pem_label':
    'This is a PEM block labelled “{label}”, not “CERTIFICATE” or “PUBLIC KEY”. This field takes AMA’s field-encryption key: either a public certificate, or the public key on its own.',
  'settings.providerCredentials.probe.detail.ama_cert_multiple_blocks':
    'More than one PEM block was pasted, and none of them was chosen for you. Blocks found: {count} ({labels}). Paste exactly one certificate or one public key.',
  'settings.providerCredentials.probe.detail.ama_cert_illegal_character':
    'The PEM body contains {character} at byte offset {offset}, which is neither base64 nor whitespace. It was left in place: removing it, or guessing what it replaced, would change the key that was read.',
  'settings.providerCredentials.probe.detail.ama_cert_base64_invalid':
    'The PEM body is not valid base64 and was not repaired: the missing part cannot be recovered. The reader reports: {detail}',
  'settings.providerCredentials.probe.detail.ama_cert_normalised':
    'Characters the base64 body does not use — whitespace, control or zero-width characters — were ignored when the text was read. Characters ignored: {removed}. The decoded bytes are unchanged.',
  'settings.providerCredentials.probe.detail.ama_key_public_key_parsed':
    'The text is read as a public key on its own (a SubjectPublicKeyInfo). It carries no certificate.',
  'settings.providerCredentials.probe.detail.ama_key_not_a_public_key':
    'The block is labelled PUBLIC KEY and its decoded bytes are not a public key. Nothing was read as a certificate instead. The reader reports: {detail}',
  'settings.providerCredentials.probe.detail.ama_key_pkcs1_not_spki':
    'This is a PEM block labelled “RSA PUBLIC KEY”: a PKCS#1 key, the modulus and the exponent with no algorithm identifier around them. This field takes the SubjectPublicKeyInfo form, which is what a “PUBLIC KEY” block holds. Convert it with: openssl rsa -RSAPublicKey_in -in key.pem -pubout',
  'settings.providerCredentials.probe.detail.ama_key_certificate_fields_absent':
    'What you supplied is a public key on its own, so it has no subject, no issuer and no validity period: those belong to a certificate, and none was supplied. They are absent, not unreadable.',
  'settings.providerCredentials.probe.detail.ama_key_private_key':
    'This is a PEM block labelled “{label}”, which is a PRIVATE key. This field takes public material only — AMA’s certificate, or its public key. The value was refused and not stored; if it is a real private key, treat it as exposed and replace it.',
  ...
  'settings.providerCredentials.probe.checkName.ama_certificate_parseable': 'AMA key readable',
  ...
  'settings.providerCredentials.probe.checkName.public_key_parsed': 'Public key read',
  'settings.providerCredentials.probe.checkName.certificate_fields': 'Certificate fields',
  ...
  'users.passkeys.name.hint':
    'Only there to tell them apart. Pick something you will still recognise in a year — this is the name you will see when you need to remove one.',
  ...
  'account.signedOut.body': 'Sign in to see and change your account settings.',
  ...
  'account.identity.adminOnly.title': 'What only an administrator may change',
  ...
  'account.suspend.body':
    'If you suspect that someone has gained access to your account, suspend it. It is the quickest way to cut that access off while the matter is looked into.',
  ...
  'account.suspend.effect.lift':
    'Only an administrator may lift the suspension — you will not be able to do it yourself.',
  ...
  // See the en-US block: concrete about the attack, and equally concrete about the
  // narrow scope of what a ticked box actually permits.
  ...
  'settings.signing.tslLegacy.unknown.label': 'Algorithm this version does not recognise',
