...
export const enGB: Catalog = {
  ...
  "users.create.credentialsLede": "Set the initial password and pass it on by a secure channel. It is never sent by e-mail.",
  ...
  "users.language.hint.auto": "Follows the language of the device the person signs in from. Messages sent by the server use the platform default.",
