...
export const nlNL: Catalog = {
  ...
  'settings.diagnostics.title': 'Diagnostiek',
  'settings.diagnostics.intro':
    'Alles wat deze installatie al over zichzelf meldt, verzameld op één scherm zodat het gekopieerd, afgedrukt of bewaard kan worden voor een supportverzoek. Niets hiervan is een nieuwe controle: elk veld komt uit een paneel dat u afzonderlijk kunt openen.',
  'settings.diagnostics.privacyNote':
    'De export bevat nooit een geheime waarde, een e-mailadres, een accountnaam of een documenttitel. Variabelen met inloggegevens verschijnen alleen als geconfigureerd of niet geconfigureerd.',
  'settings.diagnostics.unknownNote':
    'Een veld dat niet is gelezen, zegt dat ook. Geen enkele status wordt hier aangenomen: als een bron niet heeft geantwoord, of uw rol die niet mag lezen, zeggen de regel en de export dat in plaats van een uitkomst te tonen.',
  'settings.diagnostics.tableCaption': 'Diagnostiek: {section}',
  'settings.diagnostics.column.field': 'Veld',
  'settings.diagnostics.column.value': 'Waarde',
  'settings.diagnostics.copy': 'Kopiëren',
  'settings.diagnostics.copied': 'Rapport naar het klembord gekopieerd.',
  'settings.diagnostics.copyFailed':
    'Het klembord is niet beschikbaar in dit venster, dus er is niets gekopieerd. Selecteer de tabellen en kopieer ze, of download het bestand.',
  'settings.diagnostics.download': '.txt downloaden',
  'settings.diagnostics.downloaded': 'Rapport opgeslagen: {filename}',
  'settings.diagnostics.downloadFailed':
    'Het bestand kon niet worden weggeschreven. Probeer het rapport te kopiëren.',
  'settings.diagnostics.printFailed': 'Dit venster kan geen afdrukvenster openen.',
  'settings.diagnostics.actionFailed': 'Het rapport is niet geëxporteerd',
  'settings.diagnostics.source.ok': 'Gelezen',
  'settings.diagnostics.source.loading': 'Wordt gelezen…',
  'settings.diagnostics.source.notChecked': 'Niet gecontroleerd ({reason})',
  'settings.diagnostics.source.forbidden': 'Niet toegestaan voor uw rol',
  'settings.diagnostics.value.unknown': 'Niet gecontroleerd',
  'settings.diagnostics.value.error': 'Fout ({code})',
  'settings.diagnostics.section.report': 'Dit rapport',
  'settings.diagnostics.section.health': 'Server en versie',
  'settings.diagnostics.section.services': 'Platformdiensten',
  'settings.diagnostics.section.env': 'Serveromgeving',
  'settings.diagnostics.section.storage': 'Opslag en database',
  'settings.diagnostics.section.ledger': 'Integriteit van de keten',
  'settings.diagnostics.section.search': 'Zoekindex',
  'settings.diagnostics.section.trust': 'Vertrouwenslijst',
  'settings.diagnostics.section.email': 'Uitgaande e-mail',
  'settings.diagnostics.section.credentials': 'Ondertekeningsgegevens',
  'settings.diagnostics.section.notCovered': 'Bewust niet opgenomen',
  ...
  'ledger.export.table.actions': 'Acties',
  ...
  'signing.envelopes.completed': 'Verzameling voltooid',
  'signing.envelopes.open': 'Open',
  'signing.envelopes.notice.title': 'API-melding',
  'signing.envelopes.completion': 'Verplichte slots',
  'signing.envelopes.completion.summary': '{signed} van {required} met geregistreerde handtekening',
  ...
  'signing.envelopes.evidence.formNotice':
    'Legt door de operator opgegeven technisch bewijs voor dit slot vast en markeert het slot met geregistreerde handtekening. Dit neemt geen contact op met aanbieders en voltooit de envelop of notulen niet.',
  ...
  'signing.envelopes.slot.status.signed': 'Handtekening geregistreerd',
  ...
  'pairing.confirm.action': 'Code genereren',
  ...
  // reads as granted.
  'trust.cacheFallback.label': 'Herkomst',
  'trust.cacheFallback.badge.cached': 'Lokale kopie',
  'trust.cacheFallback.badge.stale': 'Verlopen lokale kopie',
  'trust.cacheFallback.title': 'Deze controle gebruikte de opgeslagen vertrouwenslijst',
  'trust.cacheFallback.title.stale': 'Deze controle gebruikte een verlopen vertrouwenslijst',
  'trust.cacheFallback.withinValidity':
    'De vertrouwenslijst kon niet worden opgehaald, dus is de opgeslagen kopie gebruikt. Die valt nog binnen de door de schemabeheerder gepubliceerde geldigheidsduur, dus het resultaat verandert niet — maar de lijst wordt pas ververst als de verbinding is hersteld.',
  'trust.cacheFallback.pastValidity':
    'De vertrouwenslijst kon niet worden opgehaald, dus is de opgeslagen kopie gebruikt — en die kopie is voorbij de door de schemabeheerder gepubliceerde geldigheidsduur. Een sindsdien ingetrokken vertrouwensdienst staat er nog steeds als verleend in. Herstel de verbinding; voorbij de ingestelde grens wordt de opgeslagen kopie geweigerd en is ondertekenen niet meer mogelijk.',
  'trust.cacheFallback.fetchedAt': 'Kopie opgehaald',
