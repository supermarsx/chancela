...
export const fiFI: Catalog = {
  ...
  'settings.diagnostics.title': 'Diagnostiikka',
  'settings.diagnostics.intro':
    'Kaikki, mitä tämä instanssi jo kertoo itsestään, koottuna yhdelle näytölle, jotta sen voi kopioida, tulostaa tai tallentaa tukipyyntöä varten. Mikään tässä ei ole uusi tarkistus: jokainen kenttä tulee paneelista, jonka voit avata erikseen.',
  'settings.diagnostics.privacyNote':
    'Vienti ei sisällä koskaan salaista arvoa, sähköpostiosoitetta, tilin nimeä eikä asiakirjan otsikkoa. Tunnuksia sisältävät muuttujat näkyvät vain tilassa määritetty tai ei määritetty.',
  'settings.diagnostics.unknownNote':
    'Kenttä, jota ei luettu, kertoo sen. Mitään tilaa ei oleteta: jos lähde ei vastannut tai roolisi ei saa lukea sitä, sekä rivi että vienti kertovat sen tuloksen näyttämisen sijaan.',
  'settings.diagnostics.tableCaption': 'Diagnostiikka: {section}',
  'settings.diagnostics.column.field': 'Kenttä',
  'settings.diagnostics.column.value': 'Arvo',
  'settings.diagnostics.copy': 'Kopioi',
  'settings.diagnostics.copied': 'Raportti kopioitiin leikepöydälle.',
  'settings.diagnostics.copyFailed':
    'Leikepöytä ei ole käytettävissä tässä ikkunassa, joten mitään ei kopioitu. Valitse taulukot ja kopioi ne tai lataa tiedosto.',
  'settings.diagnostics.download': 'Lataa .txt',
  'settings.diagnostics.downloaded': 'Raportti tallennettu: {filename}',
  'settings.diagnostics.downloadFailed':
    'Tiedostoa ei voitu kirjoittaa. Kokeile kopioida raportti.',
  'settings.diagnostics.printFailed': 'Tämä ikkuna ei voi avata tulostusikkunaa.',
  'settings.diagnostics.actionFailed': 'Raporttia ei viety',
  'settings.diagnostics.source.ok': 'Luettu',
  'settings.diagnostics.source.loading': 'Luetaan…',
  'settings.diagnostics.source.notChecked': 'Ei tarkistettu ({reason})',
  'settings.diagnostics.source.forbidden': 'Ei sallittu roolillesi',
  'settings.diagnostics.value.unknown': 'Ei tarkistettu',
  'settings.diagnostics.value.error': 'Virhe ({code})',
  'settings.diagnostics.section.report': 'Tämä raportti',
  'settings.diagnostics.section.health': 'Palvelin ja versio',
  'settings.diagnostics.section.services': 'Alustan palvelut',
  'settings.diagnostics.section.env': 'Palvelimen ympäristö',
  'settings.diagnostics.section.storage': 'Tallennus ja tietokanta',
  'settings.diagnostics.section.ledger': 'Ketjun eheys',
  'settings.diagnostics.section.search': 'Hakuindeksi',
  'settings.diagnostics.section.trust': 'Luottamuslista',
  'settings.diagnostics.section.email': 'Lähtevä sähköposti',
  'settings.diagnostics.section.credentials': 'Allekirjoitustunnukset',
  'settings.diagnostics.section.notCovered': 'Tarkoituksella pois jätetty',
  ...
  'users.totp.enrol': 'Ota kaksivaiheinen käyttöön',
  ...
  'users.sessions.revoked': 'Istunto päätetty.',
  'users.sessions.revokeOthers': 'Päätä muut istunnot',
  'users.sessions.revokedOthers': '{count} istunto(a) päätetty.',
  ...
  'signing.envelopes.evidence.formNotice':
    'Tallentaa käyttäjän antaman teknisen näytön tälle paikalle ja merkitsee paikan allekirjoituksen kirjatuksi. Se ei ota yhteyttä palveluntarjoajiin eikä viimeistele kuorta tai pöytäkirjaa.',
  ...
  'signing.envelopes.slot.status.signed': 'Allekirjoitus kirjattu',
  ...
  'pairing.deepLink.copied': 'Linkki kopioitu',
  'pairing.code.label': 'Koodi',
  'pairing.code.copy': 'Kopioi koodi',
  'pairing.code.copied': 'Koodi kopioitu',
  ...
  'pairing.confirm.action': 'Luo koodi',
  'pairing.cancel': 'Lopeta',
  'pairing.enrolled.title': 'Puhelin paritettu',
  'pairing.enrolled.body': '{label} lisättiin laitteisiisi.',
  'pairing.enrolled.toast': '{label} paritettu',
  'pairing.enrolled.done': 'Valmis',
  'pairing.devices.title': 'Paritetut laitteet',
  'pairing.devices.empty': 'Ei paritettuja laitteita',
  'pairing.devices.emptyBody': 'Et ole vielä parittanut puhelinta. Luo koodi aloittaaksesi.',
  'pairing.table.device': 'Laite',
  'pairing.table.enrolled': 'Paritettu',
  'pairing.table.status': 'Tila',
  'pairing.table.action': 'Toiminto',
  'pairing.status.active': 'Aktiivinen',
  'pairing.status.revoked': 'Peruttu',
  'pairing.revoke': 'Peruuta',
