...
import { ledgerEventLabelsSvSE } from '../ledgerEventLabels';
import { ledgerScopeLabelsSvSE } from '../ledgerScopeLabels';
import { dashboardSourceLabelsSvSE } from '../dashboardSourceLabels';
import { roleNameLabelsSvSE } from '../roleNameLabels';
import { attendeeQualityLabelsEnglish } from '../attendeeQualityLabels';

export const svSE: Catalog = {
  ...operationsEnglish,
  ...opsConfigEnglish,
  ...ledgerEventLabelsSvSE,
  ...
  'settings.serverEnv.group.notifications': 'Åtgärdscenter',
  ...
  'settings.serverEnv.group.credentials': 'Inloggningsuppgifter',
  ...
  'settings.serverEnv.secret.note': '(innehåller en inloggningsuppgift — visas aldrig här)',
  ...
  'settings.serverEnv.secret.body':
    'Detta är en hemlighet. Panelen visar bara om den är satt, aldrig värdet. Sätt den där tjänsten startas eller genom dess eget flöde för inloggningsuppgifter.',
  ...
  'settings.diagnostics.intro':
    'Allt som den här instansen redan rapporterar om sig själv, samlat på en enda skärm så att det kan kopieras, skrivas ut eller sparas till ett supportärende. Inget här är en ny kontroll: varje fält kommer från en panel som du kan öppna för sig.',
  'settings.diagnostics.privacyNote':
    'Exporten innehåller aldrig ett hemligt värde, en e-postadress, ett kontonamn eller en dokumenttitel. Variabler som bär en inloggningsuppgift visas bara som konfigurerad eller inte konfigurerad.',
  'settings.diagnostics.unknownNote':
    'Ett fält som inte lästes säger det. Ingen status antas här: om en källa inte svarade, eller om din roll inte får läsa den, säger både raden och exporten det i stället för att visa ett resultat.',
  'settings.diagnostics.tableCaption': 'Diagnostik: {section}',
  'settings.diagnostics.column.field': 'Fält',
  'settings.diagnostics.column.value': 'Värde',
  'settings.diagnostics.copy': 'Kopiera',
  'settings.diagnostics.copied': 'Rapporten kopierades till urklipp.',
  'settings.diagnostics.copyFailed':
    'Urklipp är inte tillgängligt i det här fönstret, så inget kopierades. Markera tabellerna och kopiera dem, eller ladda ned filen.',
  'settings.diagnostics.download': 'Ladda ned .txt',
  'settings.diagnostics.downloaded': 'Rapport sparad: {filename}',
  'settings.diagnostics.downloadFailed':
    'Filen kunde inte skrivas. Försök kopiera rapporten i stället.',
  'settings.diagnostics.printFailed': 'Det här fönstret kan inte öppna någon utskriftsdialog.',
  'settings.diagnostics.actionFailed': 'Rapporten exporterades inte',
  'settings.diagnostics.source.ok': 'Läst',
  'settings.diagnostics.source.loading': 'Läser…',
  'settings.diagnostics.source.notChecked': 'Inte kontrollerad ({reason})',
  'settings.diagnostics.source.forbidden': 'Inte tillåtet för din roll',
  'settings.diagnostics.value.unknown': 'Inte kontrollerad',
  'settings.diagnostics.value.error': 'Fel ({code})',
  'settings.diagnostics.section.report': 'Den här rapporten',
  'settings.diagnostics.section.health': 'Server och version',
  'settings.diagnostics.section.services': 'Plattformstjänster',
  'settings.diagnostics.section.env': 'Servermiljö',
  'settings.diagnostics.section.storage': 'Lagring och databas',
  'settings.diagnostics.section.ledger': 'Kedjans integritet',
  'settings.diagnostics.section.search': 'Sökindex',
  'settings.diagnostics.section.trust': 'Förtroendelista',
  'settings.diagnostics.section.email': 'Utgående e-post',
  'settings.diagnostics.section.credentials': 'Signeringsuppgifter',
  'settings.diagnostics.section.notCovered': 'Avsiktligt inte medtaget',
  ...
  'rbac.scope.tenant': 'Kundorganisation',
  ...
  'rbac.scope.integration': 'Koppling',
  'rbac.scope.repository': 'Lagringsplats',
  ...
  'rbac.scope.resource.desc':
    'Gäller den angivna resursen och underordnade resurser i den behöriga hierarkin.',
  'rbac.scope.tenant.pick': 'Välj organisation',
  'rbac.scope.entity.pick': 'Välj enhet',
  'rbac.scope.book.pick': 'Välj bok',
  'rbac.scope.resource.pick': 'Resurs-id',
  ...
  'entities.subnav.aria': 'Enhetens avsnitt',
  ...
  'acts.attendees.hint':
    'Namnge alla som deltog, i vilken egenskap och — vid företrädande — av vem. Utan ifyllda rader hänvisar protokollet endast till närvaroreferensen.',
  'acts.attendees.nameAria': 'Deltagarens namn',
  'acts.attendees.qualityAria': 'Deltagarens egenskap',
  'acts.attendees.presenceAria': 'Form av närvaro',
  'acts.attendees.representedByAria': 'Företrädd av',
  'acts.attendees.representedByRequired': 'Ange vem som företrädde denna deltagare.',
  'acts.attendees.capitalAria': 'Kapital (ören)',
  'acts.attendees.capitalPlaceholder': 'ören',
  ...
  'stepper.status.done': 'klart',
  'stepper.status.current': 'nuvarande steg',
  ...
  'ledger.export.document.body':
    'Exporterar loggposterna precis som fliken Logg visar dem: de filter som är aktiva där avgör vad som hamnar i filen.',
  'ledger.export.document.editFilters': 'Ändra filter under Logg',
  'ledger.export.book.title': 'Bokexporter',
  'ledger.export.book.body':
    'Två olika paket för två olika syften: ett för arkivleverans och ett för att flytta boken till en annan instans. Välj bok och därefter rätt paket.',
  'ledger.export.book.label': 'Bok att exportera',
  ...
  'ledger.export.legalHold.label': 'Markera rättsligt bevarandekrav i denna export',
  'ledger.export.legalHold.help':
    'Det påverkar bara det skapade paketet — servern sparar inte kravet på boken. Ett krav som redan noterats på boken följer med paketet även när detta är avstängt.',
  ...
  'ledger.export.bundle.body':
    'En självverifierande ZIP och det enda format som bokimporten accepterar. Använd det för att flytta eller återställa en bok på en annan instans.',
  'ledger.export.bundle.retainedTitle': 'Denna export loggas',
  'ledger.export.bundle.retained':
    'Till skillnad från bevarandepaketet behåller servern en kopia av detta paket och lägger till en händelse i granskningsloggen.',
  ...
  'pdfValidator.report.savePdf': 'Spara PDF/A-rapport',
  ...
  'users.filters.status.all': 'Alla status',
  ...
  'users.filters.clear.aria': 'Rensa användarfilter',
  ...
  'users.totp.enrol': 'Aktivera tvåfaktor',
  ...
  'users.sessions.revoked': 'Session avslutad.',
  'users.sessions.revokeOthers': 'Avsluta de andra sessionerna',
  'users.sessions.revokedOthers': '{count} session(er) avslutade.',
  ...
  'settings.registryAutoUpdate.plan.col.fieldHelp':
    'Varje rad namnger ett villkor i den plan servern har beräknat. Värdena är skrivskyddade; det är inställningarna ovan som ändrar dem.',
  ...
  'settings.registryAutoUpdate.skipped.col.reasonHelp':
    'Regeln som höll en enhet utanför den här planen. Varje enhet räknas bara en gång, vid den första orsak som gäller för den.',
  ...
  'settings.registryAutoUpdate.attempt.col.fieldHelp':
    'Varje rad beskriver den notering servern har sparat för försöket du nyss begärde.',
  ...
  'settings.registryAutoUpdate.enabled.help':
    'Huvudbrytare. Så länge den är av förfaller ingenting: alla sparade intyg räknas som överhoppade eftersom de är avstängda.',
  'settings.registryAutoUpdate.cadence.hoursHelp':
    'Intervallet, i timmar, för den frekvens som lämnas till serverns arbetare. Mellan 1 och 720.',
  ...
  'settings.registryAutoUpdate.cadence.weekdayHelp':
    'Dagen i den veckovisa frekvensen, tillsammans med UTC-timmen bredvid.',
  'settings.registryAutoUpdate.staleThreshold.help':
    'Ett intyg vars senaste förfrågan har denna ålder eller mer räknas som inaktuellt och kommer med i planen. Mellan 1 och 8760 timmar.',
  ...
  'settings.registryAutoUpdate.maxBackoff.help':
    'Taket som den fördubblade väntetiden aldrig passerar. Det får inte vara lägre än den kortaste väntetiden.',
  ...
  'settings.registryAutoUpdate.entityDefaults.help':
    'Gäller enheter som ännu inte har ett eget beslut registrerat. Ett beslut per enhet går alltid före det här värdet.',
  ...
  'acts.convening.waiver.basis.universal':
    'Universalstämma — alla närvarande och alla överens (CSC art. 54.º)',
  ...
  'acts.convening.waiver.evidenceReference': 'Bevis för överenskommelsen',
  'acts.convening.waiver.conflict':
    'Både en kallelse och avsaknaden av kallelse är registrerade. Endast en av dem kan beskriva detta möte.',
  ...
  'templates.actions.delete': 'Ta bort',
  'templates.actions.export': 'Exportera',
  'templates.actions.import': 'Importera',
  'templates.actions.save': 'Spara',
  'templates.actions.cancel': 'Avbryt',
  'templates.source.builtin': 'Inbyggd (skrivskyddad)',
  'templates.source.user': 'Skapad av användare',
  'templates.editor.title.create': 'Ny mall',
  'templates.editor.title.edit': 'Redigera mall',
  'templates.editor.intro':
    'En mall är ett återanvändbart protokollskelett: den anger dokumentets struktur och block och utgör ingen juridisk garanti.',
  ...
  'templates.import.valid': 'Filen är giltig. Du kan bekräfta importen.',
  'templates.import.invalid': 'Filen är ogiltig. Åtgärda felen innan du importerar.',
  'templates.import.confirm': 'Bekräfta import',
  'templates.delete.confirm': 'Ta bort mallen ”{id}”? Denna åtgärd kan inte ångras.',
  'templates.delete.success': 'Mall borttagen.',
  'templates.error.too_large': 'Mallfilen överskrider den tillåtna storleken.',
  'templates.error.malformed': 'Mallen är felaktigt utformad eller innehåller okända fält.',
  'templates.error.invalid_id': 'Identifieraren är ogiltig. Använd formatet user-<namn>/v<n>.',
  'templates.error.no_blocks': 'Mallen måste innehålla minst ett block.',
  'templates.error.bad_template': 'Ett av blocken innehåller ett uttrycksfel i innehållet.',
  'templates.error.unknown_threshold': 'Mallen hänvisar till ett tröskelvärde som inte finns.',
  'templates.error.unsupported_locale': 'Det angivna språket stöds inte.',
  'templates.error.conflict': 'Det finns redan en mall med denna identifierare.',
  'templates.error.id_mismatch': 'Mallens identifierare stämmer inte överens med den i länken.',
  'templates.toast.created': 'Mallen ”{id}” har skapats.',
  'templates.toast.updated': 'Mallen ”{id}” har uppdaterats.',
  'templates.toast.deleted': 'Mallen ”{id}” har tagits bort.',
  'templates.toast.imported': 'Mallen ”{id}” har importerats.',
  'templates.toast.exported': 'Mallen ”{id}” har exporterats.',
  ...
  'signing.envelopes.completed': 'Insamling slutförd',
  'signing.envelopes.open': 'Öppet',
  'signing.envelopes.notice.title': 'API-meddelande',
  'signing.envelopes.completion': 'Obligatoriska fack',
  'signing.envelopes.completion.summary': '{signed} av {required} med registrerad underskrift',
  ...
  'signing.envelopes.evidence.formNotice':
    'Registrerar tekniskt bevis som anges av operatören för detta slot och markerar slotet med registrerad signatur. Det kontaktar inte leverantörer och slutför inte kuvertet eller protokollet.',
  ...
  'signing.envelopes.slot.status.signed': 'Underskrift registrerad',
  ...
  'data.status.col.average': 'Genomsnitt per rad',
  ...
  'externalInvite.document.digest': 'Sammanfattning PDF/A',
  ...
  'settings.signing.tlsIntermediates.title': 'TLS-mellancertifikat för utgående anslutningar',
  'settings.signing.tlsIntermediates.hint':
    'En HTTPS-server ska skicka hela sin certifikatkedja utom roten. Vissa skickar bara slutcertifikatet: mellanledet saknas, ingen kedja kan byggas och anslutningen avvisas med felet UnknownIssuer. Ange det saknade mellancertifikatet här.',
  'settings.signing.tlsIntermediates.notAnAnchor':
    'Detta är inte ett förtroendeankare. Ett ankare är det certifikat som förtroendelistan signerades med; här handlar det om certifikatutfärdaren bakom TLS-certifikatet på webbservern där filen ligger. Olika certifikat, utfärdade av olika organ: ett certifikat som anges här gör aldrig en icke-äkta lista äkta.',
  'settings.signing.tlsIntermediates.scope':
    'Ingenting här hoppar över kontrollen. Det angivna certifikatet blir ytterligare ett möjligt led i kedjan, aldrig en rot: kedjan måste fortfarande sluta i en rot som operativsystemet redan litar på, servernamnet måste fortfarande stämma och giltighetsdatumen gäller alltjämt. En webbläsare eller curl kan öppna samma adress utan fel, eftersom de själva hämtar saknade certifikat; det gör inte den här klienten.',
  'settings.signing.tlsIntermediates.certs.hint': 'Mellancertifikat, i PEM eller DER.',
  'settings.signing.tlsIntermediates.certs.add': 'Lägg till mellancertifikat',
  'settings.signing.tlsIntermediates.certs.none': 'Inget mellancertifikat är konfigurerat.',
  'settings.signing.tlsIntermediates.certs.label': 'Mellancertifikat {position}',
  'settings.signing.tlsIntermediates.certs.remove': 'Ta bort mellancertifikat {position}',
  'settings.signing.tlsIntermediates.certs.placeholder':
    'Klistra in mellancertifikatet här, med början -----BEGIN CERTIFICATE-----',
  ...
  'settings.signing.source.tlsSkipVerification.label':
    'Kontrollera inte den här källans TLS-certifikat',
  'settings.signing.source.tlsSkipVerification.effect':
    'Anslutningar till den här källan görs utan att serverns identitet bekräftas. Listans äkthet beror inte på det: den kontrolleras alltjämt genom listans egen signatur mot de konfigurerade ankarna, och en förfalskad lista avvisas alltjämt.',
  'settings.signing.source.tlsSkipVerification.residual':
    'Det som däremot hamnar inom räckhåll för någon på nätverksvägen är något annat: att leverera en äkta men äldre lista — som styrker sig utmärkt, eftersom den är äkta, och där en sedermera återkallad tjänst fortfarande står som beviljad — och att helt hindra att listan hämtas.',
  'settings.signing.source.tlsSkipVerification.prefer':
    'Om orsaken är en ofullständig certifikatkedja, ange i stället det saknade mellancertifikatet: det löser hämtningen utan att ge upp autentiseringen av transporten.',
  ...
  'trust.detail.historyCount': 'Historikposter: {count}',
  ...
  'trust.table.service.name.help':
    'Tjänstens publicerade namn. Välj det för att öppna hela vyn, med digitala identiteter, tjänstepunkter och statushistorik.',
  ...
  'trust.table.service.attributes.help':
    'Den aktuella statusen plus de attribut som listan tillskriver tjänsten: om den är en kvalificerad certifikatutfärdare, om den är kvalificerad eller betrodd för elektroniska underskrifter, om den har en statushistorik och om den anger tjänstepunkter.',
  ...
  'fieldHelp.acts.attendeePresence':
    'Närvarande, företrädd eller frånvarande. Avgör vad protokollet återger på denna rad.',
  'fieldHelp.acts.attendeeRepresentedBy':
    'Namnet på den som företrädde denna deltagare. Krävs när närvaron är ”Företrädd”.',
  'fieldHelp.acts.attendeeWeight':
    'Röstvikten för denna rad: kapital i ören för bolag, andel i promille för samfälligheter.',
  ...
  'settings.email.status.caption': 'Översikt över e-postkonfigurationens status',
  'settings.email.status.col.setting': 'Inställning',
  'settings.email.status.col.value': 'Aktuellt värde',
  'settings.email.status.col.state': 'Status',
  'settings.email.status.row.relay': 'Sändande server',
  'settings.email.status.row.encryption': 'Skydd av anslutningen',
  'settings.email.status.row.authentication': 'Inloggning mot servern',
  'settings.email.status.row.sender': 'Avsändare',
  'settings.email.status.row.lastTest': 'Senaste testutskicket',
  ...
  'settings.email.status.neverTested': 'Inget test i den här sessionen',
  'settings.email.status.testOk': 'Accepterat',
  'settings.email.status.testFailed': 'Avvisat',
  'settings.email.status.ready': 'Klar att skicka',
  'settings.email.status.notReady': 'Konfigurationen är ofullständig',
  'settings.email.status.off': 'Utskick avaktiverat',
  ...
  'settings.email.trace.lede':
    'Vad som hände under anslutningen till servern, fas för fas. Användbart för att felsöka en utskicksserver utan åtkomst till konsolen.',
  ...
  'settings.email.server.lede':
    'Var och hur programmet ansluter till e-postservern. Port och kryptering måste stämma med vad servern erbjuder.',
  'settings.email.auth.cardTitle': 'Inloggningsuppgifter',
  'settings.email.auth.lede':
    'Hur programmet identifierar sig mot servern. Lösenordet lagras krypterat och returneras aldrig.',
  'settings.email.identity.cardTitle': 'Avsändarens identitet',
  'settings.email.identity.lede':
    'Vem mottagaren ser som avsändare, och namnet som programmet presenterar sig med för servern.',
  'settings.email.insecure.consequence':
    'Utan bekräftelsen nedan vägrar servern att spara den här konfigurationen: okrypterat utskick måste vara ett medvetet val.',
  ...
  'pairing.lede':
    'Para ihop en telefon med denna instans för att använda den som följeslagarapp. Skapa en kod, skanna den på telefonen och slutför parkopplingen.',
  'pairing.label.label': 'Enhetsnamn',
  'pairing.label.hint': 'Ett namn för att känna igen denna telefon i enhetslistan.',
  'pairing.label.placeholder': 'Amélias telefon',
  'pairing.connect': 'Skapa parkopplingskod',
  ...
  'pairing.deepLink.copy': 'Kopiera länk',
  'pairing.deepLink.copied': 'Länk kopierad',
  'pairing.code.label': 'Kod',
  'pairing.code.copy': 'Kopiera kod',
  'pairing.code.copied': 'Kod kopierad',
  ...
  'companionPair.lede':
    'Bekräfta att det är du för att slutföra parkopplingen. Ett av alternativen nedan räcker.',
  ...
  'companionPair.method.emailed_code': 'Kod skickad med e-post',
  'companionPair.hint.password': 'Lösenordet till ditt konto.',
  'companionPair.hint.totp_code': 'Den sexsiffriga kod som din autentiseringsapp visar just nu.',
  'companionPair.hint.emailed_code':
    'Koden du fick med e-post. Du kan skriva den med eller utan bindestreck.',
  ...
  'companionPair.done.body': 'Den här enheten har nu åtkomst till ditt konto. Du kan stänga sidan.',
  ...
  'pairing.enrolled.toast': '{label} parkopplad',
  'pairing.enrolled.done': 'Klar',
  'pairing.devices.title': 'Parkopplade enheter',
  'pairing.devices.empty': 'Inga parkopplade enheter',
  'pairing.devices.emptyBody':
    'Du har inte parkopplat någon telefon ännu. Skapa en kod för att komma igång.',
  'pairing.table.device': 'Enhet',
  'pairing.table.enrolled': 'Parkopplad den',
  'pairing.table.status': 'Status',
  'pairing.table.action': 'Åtgärd',
  'pairing.status.active': 'Aktiv',
  'pairing.status.revoked': 'Återkallad',
  'pairing.revoke': 'Återkalla',
  'pairing.revoke.confirm': 'Bekräfta återkallande',
  ...
  'books.detail.termo.pending.body':
    'Visar de fält i öppningspåskriften som registrerades när boken öppnades. Påskriften är ännu inte ett ifyllbart eller signerbart instrument i detta gränssnitt, och den genererade PDF/A-filen har ingen egen slutpunkt — den följer med i bevarandepaketet som erbjuds i sidhuvudet.',
  'books.detail.retention.scopeNote':
    'Endast de bevarandekandidater som nämner denna bok. Bevarandepolicyer hanteras under Inställningar → Integritet.',
  ...
  'settings.signing.providers.help.status':
    'Om sättet är redo att användas. ”Konfigurerad” betyder att den icke-hemliga konfiguration som krävs finns på plats; ”Blockerad i produktion” att något som krävs utanför test saknas; ”Endast lokal” markerar de sätt som bara fungerar med en process på själva maskinen; ”Ej konfigurerad” att inget ännu har angetts.',
  ...
  'settings.providerCredentials.entry.test': 'Testa den här uppgiften',
  'settings.providerCredentials.probe.modal.title': 'Test av inloggningsuppgiften',
  ...
  'settings.providerCredentials.probe.detail.entry_disabled':
    'Den sparade inloggningsuppgiften är avstängd.',
  'settings.providerCredentials.probe.detail.entry_enabled':
    'Den sparade inloggningsuppgiften är påslagen.',
  'settings.providerCredentials.probe.detail.mode_not_signing_provider':
    'Den här sortens inloggningsuppgift är inte en signeringsleverantör.',
  ...
  'settings.providerCredentials.probe.detail.cmd_credential_assembly_failed':
    'Den sparade inloggningsuppgiften kunde inte omvandlas till en användbar CMD-konfiguration.',
  ...
  'users.create.identityLede':
    'Vem personen är. Användarnamnet identifierar hen i granskningsloggen och kan inte ändras senare.',
  'users.create.emailHint': 'Krävs för att skicka välkomstmeddelandet.',
  'users.create.accessCard': 'Åtkomst',
  'users.create.accessLede':
    'Rollen och den omfattning den gäller i, tilldelade i samma begäran som skapar kontot.',
  'users.create.scope.label': 'Omfattning',
  'users.create.scope.hint': 'Var rollen gäller. Global omfattar hela instansen.',
  'users.create.role.label': 'Roll',
  'users.create.role.hint':
    'Endast roller vars behörighet du redan har i denna omfattning erbjuds.',
  'users.create.role.default': 'Serverns standard (Gestor, global)',
  'users.create.role.optionBlocked': '{role} — över din behörighet',
  'users.create.role.carries': 'Denna roll ger',
  'users.create.role.aboveCeiling':
    'Du kan inte tilldela {role}: den innehåller rättigheter som du inte har i denna omfattning ({permissions}).',
  'users.create.role.defaultNote':
    'Utan vald roll får kontot serverns standard: Gestor, i global omfattning.',
  'users.create.credentialsCard': 'Inloggningsuppgifter',
  'users.create.credentialsLede':
    'Ange det första lösenordet och vidarebefordra det via en säker kanal. Det skickas aldrig med e-post.',
  ...
  'users.create.notifyCard': 'Avisering',
  'users.create.notifyLede':
    'Valfritt meddelande om att kontot finns. Meddelandet innehåller varken lösenord, kod eller inloggningslänk.',
  'users.create.welcome.label': 'Skicka ett välkomstmeddelande till det nya kontot',
  'users.create.welcome.noSmtp':
    'E-postutskick är inte konfigurerat, så meddelandet kan inte skickas.',
  'users.create.welcome.noAddress': 'Ange en e-postadress ovan för att kunna skicka meddelandet.',
  'users.create.welcome.settingsLink': 'Konfigurera e-post',
  'users.language.label': 'Språk',
  'users.language.auto': 'Identifiera automatiskt',
  ...
  // reads as granted.
  'trust.cacheFallback.label': 'Ursprung',
  'trust.cacheFallback.badge.cached': 'Lokal kopia',
  'trust.cacheFallback.badge.stale': 'Utgången lokal kopia',
  'trust.cacheFallback.title': 'Den här kontrollen använde den sparade förtroendelistan',
  'trust.cacheFallback.title.stale': 'Den här kontrollen använde en utgången förtroendelista',
  'trust.cacheFallback.withinValidity':
    'Förtroendelistan kunde inte hämtas, så den sparade kopian användes. Den ligger fortfarande inom den giltighetstid som systemets operatör publicerat, så resultatet påverkas inte — men listan uppdateras inte förrän anslutningen är återställd.',
  'trust.cacheFallback.pastValidity':
    'Förtroendelistan kunde inte hämtas, så den sparade kopian användes — och den kopian har passerat den giltighetstid som systemets operatör publicerat. En förtroendetjänst som dragits tillbaka sedan dess står fortfarande som beviljad i den. Återställ anslutningen; bortom den konfigurerade gränsen avvisas den sparade kopian och det går inte längre att signera.',
  'trust.cacheFallback.fetchedAt': 'Kopia hämtad',
  ...
  'trust.unverifiedTransport.badge': 'Ej autentiserad',
  'trust.unverifiedTransport.title': 'Listan hämtad utan att servern autentiserats',
  'trust.unverifiedTransport.body':
    'Den här förtroendelistan hämtas från en källa vars TLS-certifikat inte kontrolleras, enligt ett val i signeringsinställningarna.',
  'trust.unverifiedTransport.stillAuthenticated':
    'Detta ifrågasätter inte listans äkthet. Listan autentiseras genom sin egen signatur, prövad mot de konfigurerade förtroendeankarna — en kontroll som förblir obligatorisk och som en förfalskad lista inte klarar.',
  'trust.unverifiedTransport.residualRisk':
    'Det som hamnar inom räckhåll för någon på nätverksvägen: att leverera en äkta men äldre lista, där en sedermera återkallad tjänst fortfarande står som beviljad, och att hindra att listan hämtas.',
  'trust.unverifiedTransport.remedy':
    'Om orsaken är en ofullständig certifikatkedja återställer det saknade mellancertifikatet kontrollen av servern utan någon förlust.',
  'trust.unverifiedTransport.unknown':
    'Den här förtroendelistan hämtas utan att serverns certifikat kontrolleras. Listans signatur prövas alltjämt mot de konfigurerade ankarna.',
