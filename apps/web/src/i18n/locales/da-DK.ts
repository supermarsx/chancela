...
export const daDK: Catalog = {
  ...
  'settings.diagnostics.intro':
    'Alt, hvad denne instans allerede rapporterer om sig selv, samlet på én skærm, så det kan kopieres, udskrives eller gemmes til en supportsag. Intet her er en ny kontrol: hvert felt kommer fra et panel, du kan åbne for sig.',
  'settings.diagnostics.privacyNote':
    'Eksporten indeholder aldrig en hemmelig værdi, en e-mailadresse, et kontonavn eller en dokumenttitel. Variabler med legitimationsoplysninger vises kun som konfigureret eller ikke konfigureret.',
  'settings.diagnostics.unknownNote':
    'Et felt, der ikke er læst, siger det. Ingen status antages her: hvis en kilde ikke har svaret, eller din rolle ikke må læse den, siger både rækken og eksporten det i stedet for at vise et resultat.',
  'settings.diagnostics.tableCaption': 'Diagnostik: {section}',
  'settings.diagnostics.column.field': 'Felt',
  'settings.diagnostics.column.value': 'Værdi',
  'settings.diagnostics.copy': 'Kopiér',
  'settings.diagnostics.copied': 'Rapporten er kopieret til udklipsholderen.',
  'settings.diagnostics.copyFailed':
    'Udklipsholderen er ikke tilgængelig i dette vindue, så der blev ikke kopieret noget. Markér tabellerne og kopiér dem, eller hent filen.',
  'settings.diagnostics.download': 'Hent .txt',
  'settings.diagnostics.downloaded': 'Rapport gemt: {filename}',
  'settings.diagnostics.downloadFailed':
    'Filen kunne ikke skrives. Prøv at kopiere rapporten i stedet.',
  'settings.diagnostics.printFailed': 'Dette vindue kan ikke åbne en udskriftsdialog.',
  'settings.diagnostics.actionFailed': 'Rapporten blev ikke eksporteret',
  'settings.diagnostics.source.ok': 'Læst',
  'settings.diagnostics.source.loading': 'Læser…',
  'settings.diagnostics.source.notChecked': 'Ikke kontrolleret ({reason})',
  'settings.diagnostics.source.forbidden': 'Ikke tilladt for din rolle',
  'settings.diagnostics.value.unknown': 'Ikke kontrolleret',
  'settings.diagnostics.value.error': 'Fejl ({code})',
  'settings.diagnostics.section.report': 'Denne rapport',
  'settings.diagnostics.section.health': 'Server og version',
  'settings.diagnostics.section.services': 'Platformstjenester',
  'settings.diagnostics.section.env': 'Servermiljø',
  'settings.diagnostics.section.storage': 'Lager og database',
  'settings.diagnostics.section.ledger': 'Kædens integritet',
  'settings.diagnostics.section.search': 'Søgeindeks',
  'settings.diagnostics.section.trust': 'Tillidsliste',
  'settings.diagnostics.section.email': 'Udgående e-mail',
  'settings.diagnostics.section.credentials': 'Signaturlegitimation',
  'settings.diagnostics.section.notCovered': 'Bevidst ikke medtaget',
  ...
  'acts.aiReview.packet.copy': 'Kopiér gennemgangspakke',
  'acts.aiReview.packet.copiedButton': 'Pakke kopieret',
  'acts.aiReview.packet.copied': 'Gennemgangspakke kopieret.',
  'acts.aiReview.packet.copyFailed': 'Kunne ikke kopiere gennemgangspakken.',
  ...
  'ledger.archive.scope.help':
    'Aktuel side bruger grænsen Hændelser pr. side; alle filtrerede JSON/TXT/CSV/HTML-data streames på serveren uden at indlæse flere poster i tabellen; PDF/A for alle filtrerede poster har en serversikkerhedsgrænse på 1.000 poster og fejler uden afkortning, hvis den overskrides.',
  ...
  'ledger.archive.format.help':
    'For Aktuel side bruges aktive filtre, nyeste først og grænsen Hændelser pr. side; for Alle filtrerede poster eksporterer JSON/TXT/CSV/HTML alle matches via streaming, mens PDF/A er begrænset af hensyn til hukommelsen.',
  ...
  'users.totp.enrol': 'Aktivér tofaktor',
  ...
  'users.sessions.revoked': 'Session afsluttet.',
  'users.sessions.revokeOthers': 'Afslut de andre sessioner',
  'users.sessions.revokedOthers': '{count} session(er) afsluttet.',
  ...
  'templates.actions.delete': 'Slet',
  'templates.actions.export': 'Eksportér',
  'templates.actions.import': 'Importér',
  'templates.actions.save': 'Gem',
  'templates.actions.cancel': 'Annuller',
  'templates.source.builtin': 'Indbygget (skrivebeskyttet)',
  ...
  'templates.import.valid': 'Filen er gyldig. Du kan bekræfte importen.',
  'templates.import.invalid': 'Filen er ugyldig. Ret fejlene før import.',
  'templates.import.confirm': 'Bekræft import',
  'templates.delete.confirm': 'Slet skabelonen “{id}”? Denne handling kan ikke fortrydes.',
  'templates.delete.success': 'Skabelon slettet.',
  'templates.error.too_large': 'Skabelonfilen overskrider den tilladte størrelse.',
  'templates.error.malformed': 'Skabelonen er forkert udformet eller indeholder ukendte felter.',
  'templates.error.invalid_id': 'Id’et er ugyldigt. Brug formatet user-<navn>/v<n>.',
  'templates.error.no_blocks': 'Skabelonen skal indeholde mindst én blok.',
  'templates.error.bad_template': 'En af blokkene indeholder en udtryksfejl i indholdet.',
  'templates.error.unknown_threshold': 'Skabelonen henviser til en tærskel, der ikke findes.',
  'templates.error.unsupported_locale': 'Det angivne sprog understøttes ikke.',
  'templates.error.conflict': 'Der findes allerede en skabelon med dette id.',
  'templates.error.id_mismatch': 'Skabelonens id svarer ikke til det i linket.',
  'templates.toast.created': 'Skabelonen “{id}” er oprettet.',
  'templates.toast.updated': 'Skabelonen “{id}” er opdateret.',
  'templates.toast.deleted': 'Skabelonen “{id}” er slettet.',
  'templates.toast.imported': 'Skabelonen “{id}” er importeret.',
  'templates.toast.exported': 'Skabelonen “{id}” er eksporteret.',
  ...
  'signing.envelopes.completed': 'Indsamling fuldført',
  'signing.envelopes.open': 'Åben',
  'signing.envelopes.notice.title': 'API-besked',
  'signing.envelopes.completion': 'Obligatoriske slots',
  'signing.envelopes.completion.summary': '{signed} af {required} med registreret underskrift',
  ...
  'signing.envelopes.evidence.formNotice':
    'Registrerer operatørangivet teknisk bevis for dette slot og markerer slottet med registreret underskrift. Det kontakter ikke udbydere og afslutter ikke konvolutten eller protokollen.',
  ...
  'signing.envelopes.slot.status.signed': 'Underskrift registreret',
  ...
  'pairing.deepLink.copied': 'Link kopieret',
  'pairing.code.label': 'Kode',
  'pairing.code.copy': 'Kopiér kode',
  'pairing.code.copied': 'Kode kopieret',
  ...
  'pairing.enrolled.toast': '{label} parret',
  ...
  'pairing.table.action': 'Handling',
  'pairing.status.active': 'Aktiv',
  'pairing.status.revoked': 'Tilbagekaldt',
  'pairing.revoke': 'Tilbagekald',
