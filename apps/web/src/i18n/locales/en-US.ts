...
export const enUS = {
  ...
  'settings.providerCredentials.field.amaCertPem.inspect.fingerprintHint':
    'Compare this with the fingerprint AMA gave you. It is the only thing on this panel that can tell you whether this is the right certificate, and the application does not compare it for you.',
  ...
  'settings.providerCredentials.probe.detail.ama_cert_armour_missing':
    'No PEM armor was found: the text must contain a line reading exactly -----BEGIN CERTIFICATE-----. None was added around what you pasted.',
  ...
  'settings.providerCredentials.probe.detail.ama_cert_wrong_pem_label':
    'This is a PEM block labeled “{label}”, not “CERTIFICATE”. This field takes AMA’s public certificate — never a private key.',
