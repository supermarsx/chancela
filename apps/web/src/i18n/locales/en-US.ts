...
export const enUS = {
  ...
  'settings.diagnostics.privacyNote':
    'The export never carries a secret value, an email address, an account name or a document title. Variables that hold a credential appear only as configured or not configured.',
  ...
  'settings.diagnostics.printFailed': 'This window cannot open a print dialog.',
  ...
  'settings.diagnostics.section.email': 'Outbound email',
  ...
  'rbac.deleg.funcao.unknown': 'Role removed from the catalog',
  ...
  'ledger.export.book.body':
    'Two different packages for two different purposes: one for archival deposit, one for moving the book to another instance. Pick the book, then the right package.',
  ...
  'ledger.export.preservation.contents':
    'It carries the book’s preserved PDF/A files, the evidence index, the per-signature evidence reports, the PDF accessibility reports, the external-validator reports, the generated dispatch evidence and, when a legal hold applies, its JSON record.',
  ...
  'templates.error.malformed': 'The template is malformed or contains unrecognized fields.',
  ...
  'signing.phone.forget.action': 'Delete number',
  'signing.phone.forget.intro':
    'Confirm your identity to delete the saved number. It will no longer be filled in for you, and you will have to type it for every signature.',
  'signing.phone.forget.title': 'Delete the saved number',
  ...
  'signing.phone.remember.hint':
    'The number is encrypted with your own credentials and can be read only in your sessions. You can delete it at any time.',
  ...
  'signing.phone.remember.locked.body':
    'A number is saved that this session cannot decrypt. If you signed in without your password, sign in again with it; if the account’s attestation key has since been replaced, clear the checkbox and save the number again.',
  ...
  'signing.envelopes.guardrail.body':
    'Envelopes and linked invites track operational workflow. Slot evidence is operator-supplied technical metadata only. They do not contact providers, sign the PDF, or make qualified-signature, trust-validation, legal-status, act-finalization, or envelope-completion claims.',
  ...
  'toast.signing.phoneForgotten': 'Number deleted.',
  ...
  'documents.metadata.generatedAt': 'Generated at',
  ...
  'documents.accessibility.aria': 'PDF accessibility technical evidence',
  'documents.accessibility.title': 'PDF accessibility technical evidence',
  'documents.accessibility.hint':
    'Local technical metadata only; it does not claim PDF/UA, DGLAB certification, legal validity, or signed-PDF accessibility compliance.',
  'documents.accessibility.status': 'Status',
  'documents.accessibility.status.attached': 'Evidence attached',
  'documents.accessibility.status.unavailable': 'Evidence unavailable',
  ...
  'documents.import.notice':
    'Imported documents are kept as non-canonical evidence or reference. They do not replace the preserved PDF/A or any signed PDF; importing does not assert legal validity, PDF/A conformance, or signature validity.',
  ...
  'documents.import.empty.body': 'These minutes have no imported evidence or reference yet.',
  ...
  'documents.import.importedAt': 'Imported at',
  ...
  'settings.signing.anchorSuggest.rootSelfAsserted.title':
    'The anchor this was checked against may not be verified',
  'settings.signing.anchorSuggest.rootSelfAsserted.body':
    "One of the configured trust anchors came from a document that vouched for itself, and nobody has compared it against a published value yet. The check reports that the List of Trusted Lists matched an anchor, never which one, so this list may have been authenticated against that unverified anchor — and every certificate suggested below descends from it. Compare that anchor's SHA-256 fingerprint against the one published in the Official Journal of the European Union and mark it as checked. Until then, anything you accept here is recorded as unverified too.",
  ...
  'trust.filter.withSupplyPoint': 'With service point',
  ...
  'trust.detail.supplyPoints': 'Service points',
  ...
  'trust.tsa.detail.empty.body':
    'Choose a record to view metadata, service points, and identities.',
  ...
  'fieldHelp.registry.capitalRealization':
    'Capital realization note transcribed from the certificate.',
  ...
  'settings.language.lede':
    'A preference on your account: it applies to you in any browser you sign in from, and to nobody else on this instance.',
  'settings.language.field.label': 'Language',
  'settings.language.field.hint':
    'Pick a fixed language, or leave it automatic to follow the browser.',
  ...
  'settings.language.autoResolves':
    'On this browser, “automatic” shows {locale}. The stored preference is still “automatic”, so on another computer it follows that browser instead.',
  'settings.language.notTheme':
    'The theme follows the operating system; the language follows the browser. They are different mechanisms, however alike the options look.',
  ...
  'acts.body.editor.placeholders':
    'The {{ … }} fields are only highlighted, never locked: you can delete, move or retype them like any other text.',
  ...
  'acts.body.rejected.remedy':
    'Fix or remove that construct. The server refuses it rather than deleting it, so you never approve text the sealed document does not contain.',
  ...
  'acts.body.paste.downgraded':
    '{construct} ({count}) — turned into paragraphs. The words stayed; the structure did not.',
  'acts.body.paste.why':
    'An ata holds only headings, paragraphs, bold, italic and horizontal rules. We would rather tell you what changed than let you find out it was missing.',
  'acts.body.paste.dismiss': 'Got it',
  ...
  'acts.body.construct.quote': 'Quote',
  ...
  'settings.providerCredentials.protection.obfuscation.title': 'Obfuscation — defense in depth',
  ...
  'settings.providerCredentials.entry.unlabeled': 'Unlabeled entry',
  ...
  'settings.providerCredentials.field.authorization': 'Authorization',
  ...
  'settings.providerCredentials.help.authorization':
    'How the signing session is authorized at the QTSP. E.g. “Service” for account credentials, “User” when each signatory authorizes.',
  ...
  // --- The credential-test dialog (t112): progress and the per-check log ---
  ...
  // --- Probe diagnostics: the server's own per-check sentences, localized (t112) ---
  // The probe sends each assertion in English PLUS a stable `detail_code`
  // (`crates/chancela-api/src/provider_probe_codes.rs`); `i18n/providerProbeDiagnostics.ts` maps
  // the code to the key below. The interpolated values — {field}, {environment}, {endpoint},
  // {certs_setting}, {count}, {detail} — are machine identifiers, numbers, or the signing path's
  // own words. They are NEVER translated in any locale: they are what an operator types into a
  // form or greps a config for. Translate the sentence around them.
  ...
  'settings.providerCredentials.probe.detail.csc_service_authorization_incomplete':
    'Service authorization requires {client_id_field} and {client_secret_field}.',
  'settings.providerCredentials.probe.detail.csc_user_authorization_incomplete':
    'User authorization requires {token_field}.',
  ...
  'settings.providerCredentials.probe.detail.csc_authenticated':
    'CSC authentication completed without requesting any signer authorization.',
  ...
  // --- The AMA field-encryption certificate field: file, clipboard, inspect (t112) ---
  // The field stores the certificate's CONTENT. `CHANCELA_CMD_AMA_CERT_PEM` is the environment
  // route and takes a PATH; the copy below never blurs the two.
  ...
  'settings.providerCredentials.probe.detail.ama_cert_armour_missing':
    'No PEM armor was found: the text must contain a line reading exactly -----BEGIN CERTIFICATE----- or -----BEGIN PUBLIC KEY-----. None was added around what you pasted.',
  ...
  'settings.providerCredentials.probe.detail.ama_cert_wrong_pem_label':
    'This is a PEM block labeled “{label}”, not “CERTIFICATE” or “PUBLIC KEY”. This field takes AMA’s field-encryption key: either a public certificate, or the public key on its own.',
  ...
  'settings.providerCredentials.probe.detail.ama_key_not_a_public_key':
    'The block is labeled PUBLIC KEY and its decoded bytes are not a public key. Nothing was read as a certificate instead. The reader reports: {detail}',
  'settings.providerCredentials.probe.detail.ama_key_pkcs1_not_spki':
    'This is a PEM block labeled “RSA PUBLIC KEY”: a PKCS#1 key, the modulus and the exponent with no algorithm identifier around them. This field takes the SubjectPublicKeyInfo form, which is what a “PUBLIC KEY” block holds. Convert it with: openssl rsa -RSAPublicKey_in -in key.pem -pubout',
  ...
  'settings.providerCredentials.probe.detail.ama_key_private_key':
    'This is a PEM block labeled “{label}”, which is a PRIVATE key. This field takes public material only — AMA’s certificate, or its public key. The value was refused and not stored; if it is a real private key, treat it as exposed and replace it.',
  ...
  'trust.cacheFallback.unknown':
    'This check used a stored copy of the Trusted List, for a reason this version does not recognize.',
