...
rendering is AI/UX human-review coverage. Retained-export cleanup dry-run
...
transport, unreviewed finalization, draft-vs-signed comparison, DRE
verification, verified law references, legal thresholds, anonymization/redaction
completion, GDPR erasure, legal disposal, or legal-effect claims.
...
- **Recent-landed checkpoint:** `npm run test:checkpoint:recent-landed` and the GitHub Actions
  ...
  prompt/resource markers, external-signing
...
- MCP draft human-verification states are exposed in output envelopes, and AI-origin act drafts now
  ...
  signing/trust operation, draft-vs-signed comparison, a complete provenance
  experience, or acceptance of draft text as final minutes. The MCP status and
  spec-coverage resources are local snapshots, and the MCP human-review,
  compliance, paper-book OCR, and workflow provenance review prompts/resources
  are static offline guidance with no bridge/API/provider calls, no secrets, and
  no legal, source-certification, provider, trust, external, AI-completion, or
