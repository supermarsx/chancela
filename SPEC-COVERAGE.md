...
- Working tree keeps Documents/CI **PARTIAL**: PDF accessibility report JSON
  version 8 now includes bounded marked-content coverage counts plus
  writer-owned decorative-artifact evidence via
...
- Accessibility metadata, mapped inter-word spaces, PDF table-structure
  semantics, decomposed PDF/UA blocker reports, version 8 structural-depth,
  marked-content coverage, and writer-owned decorative-artifact evidence,
