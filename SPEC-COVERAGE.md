...
*Updated 2026-07-14 from current implementation snapshot `ddc176497f0b8837d357e35161ec2c260a793ac2`,
...
- Current `6a2c91e` keeps Data/Roles/CI **PARTIAL**: ROL-02 default role
  ...
  roles.
- Current `ddc1764` keeps Data/Architecture/CI **PARTIAL**: the
  ...
  database. Only the per-book portability paths (`export_book`, `import_book`,
  ...
  recovery marker coverage plus local advisory-lock/fail-closed gating only:
  SQLite remains the default, Postgres selection is feature/config gated, and
  this is not production Postgres readiness, live DB validation, migration
