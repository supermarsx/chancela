...
*Updated 2026-07-10 from committed implementation snapshot `2810242`, including
...
ASiC-S signing support, bounded tagged PDF structure, and local long-term
signature evidence status. It is an implementation and test coverage snapshot,
not a legal certification, not production CMD approval, and not a claim that
qualified-trust production operation is complete.*
