...
*Updated 2026-07-10 through committed implementation snapshot `a54b00684938d33fa31dd380051be20e611a7d82`,
...
prompt and `a54b006` browser data-key rotation execution E2E. Earlier coverage text remains prior snapshot context. All top-level spec areas remain **PARTIAL**.
...
- **Recent-landed checkpoint:** `npm run test:checkpoint:recent-landed` and the GitHub Actions
  ...
  coverage, static imported-document review notification/export browser markers, static data-key
  rotation execution browser markers, validator corpus sidecar validation, CLI encrypted-key
