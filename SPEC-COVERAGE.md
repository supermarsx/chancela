...
*Updated 2026-07-10 from committed implementation snapshot `0aab1f6`, including
the platform log, entity-list ergonomics, data-storage status, and local PDF
signature-validation slices. It is an implementation coverage snapshot, not a
