...
*Updated 2026-07-10 from committed implementation snapshot `4e1086d`, including
the platform log, entity-list ergonomics, data-storage status/cleanup, local PDF
signature-validation, PDF validator UI, template-filter, trust-provider settings,
browser E2E matrix, and UI polish slices. It is an implementation coverage
snapshot, not a legal certification and not a claim that qualified-trust
production operation is complete.*
...
- Data lifecycle/storage: the cleanup endpoint covers crash reports and retained exports only;
  auditable retention execution, disposal execution, broader export-retention policy controls,
...
- Data cleanup is bounded storage maintenance for crash reports and retained exports; it is not
  GDPR erasure, legal retention execution, archive disposal, or certification of data-lifecycle
  compliance.
