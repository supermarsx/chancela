...
*Updated 2026-07-10 through committed implementation snapshot `c66ea3f83be096a39f47ecf02b53eb782f46f892`,
...
- Workflow breadth: legal-calendar preset depth beyond the advisory dashboard reminder, broader OCR
  ...
  operator-configured local OCR run, non-authoritative OCR draft metadata/review UI, and preflight evidence,
...
- Paper-book local OCR run, OCR draft review metadata, and UI record bounded command status and
  non-authoritative review drafts with explicit false canonical/signature/legal flags. They do not
  store authoritative text, create canonical minutes, create canonical documents, sign anything,
  certify OCR accuracy, or accept historical scans as legally converted digital records.
