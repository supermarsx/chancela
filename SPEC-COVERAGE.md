...
*Updated 2026-07-10 from committed implementation snapshot `156abf3`, including
...
evidence imports and validation UI, bounded ASiC-S signing support, PDF
accessibility metadata modeling, bounded tagged PDF structure, and local
long-term signature evidence status. It is an implementation coverage snapshot, not a
...
- Trust/signing depth: production/legal B-LT/B-LTA, XAdES, ASiC-E/XAdES/multi-payload/manifests,
  ...
  collection for the corpus, and external signer legal completion.
