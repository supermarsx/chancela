...
*Updated 2026-07-14 from current implementation snapshot `0a83517b09797558f32974a9f7bed48dc6746a98`,
...
checkpoint documentation, and `0a83517` Postgres logical
backup/restore/recovery with fixity and atomicity markers.
...
validation, migration completeness, HA/cloud deployment, certification, or
...
- Current `6a2c91e` keeps Data/Roles/CI **PARTIAL**: ROL-02 default role
  ...
  roles.
- Current `0a83517` keeps Data/Architecture/CI **PARTIAL**: the
  ...
  SQLite-bundle refusal. Default CI still does not run against a live Postgres
  ...
  recovery marker coverage only: SQLite remains the default, Postgres selection
  is feature/config gated, and this is not production Postgres readiness, live
...
- **Postgres store runtime write/read and logical recovery paths:** the
  ...
  backup/restore/recovery. Default CI still does not run a live Postgres
  ...
  only, not production Postgres readiness, live DB validation, migration
