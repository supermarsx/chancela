...
- Signing DSS/trust-validation checkpoint: `63df508` is the signing validation
  implementation checkpoint inside the current `671b7ef` snapshot. Static markers pin
...
annotation and remedy-classification evidence plus the current `671b7ef` snapshot's privacy
