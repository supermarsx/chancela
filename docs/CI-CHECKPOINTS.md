...
- Signing DSS/trust-validation checkpoint: `63df508` is the signing validation
  implementation checkpoint inside the current `95e593d` snapshot. Static markers pin
...
annotation and remedy-classification evidence plus the current `95e593d` snapshot's privacy
